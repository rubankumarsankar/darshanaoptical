...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { url: "/eye-testing", priority: 0.9, changeFrequency: "monthly" as const },
    { url: "/progressive", priority: 0.8, changeFrequency: "monthly" as const },
    ...
    { url: "/frame-finder", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/lens-finder", priority: 0.7, changeFrequency: "monthly" as const },
